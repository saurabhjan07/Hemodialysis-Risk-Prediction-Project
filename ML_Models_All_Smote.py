# -*- coding: utf-8 -*-
"""
Created on Mon Jul 30 14:21:45 2018
...
data = pd.read_csv('E:\HRV Data Analysis\HRV_CleanedData_FFM_LFM\MainDataFiles\Final Files- Models\Model1_1_1.csv', header=0)
...
data.drop(data.columns[[1,3,6,9,12]], axis=1, inplace=True)
data.shape
data.columns
X_All.columns
X_All.shape
...
accuracies= cross_val_score(estimator=clf6, X= X_All,y= y_All,cv=3)
a1=accuracies.mean() #accuracy
a2=accuracies.std()
print(a1)
print(a2)

roc= cross_val_score(estimator=clf6, X= X_train, y= y_train, cv=10, scoring='roc_auc') 
r1=roc.mean()
r2=roc.std() #auc
print(r1)
print(r2)
